...
parameter::parameter(int n_midi_control, int n_mux_address, int n_mux_position, function <double (double)> n_scaling_function, function<void(double)>n_update_function) {
